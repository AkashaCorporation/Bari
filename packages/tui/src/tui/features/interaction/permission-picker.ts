  ...
  constructor(
    ...
    const decisions: Array<{
          ...
          ]),
      {
        ...
        label:
          request.allowAlwaysSupported === false
            ? '2 Deny and guide Bari'
            : '3 Deny and guide Bari',
      },
    ];
  ...
  private buildFrameModel(width: number): PermissionFrameModel {
    ...
    if (this.denyFeedback) {
      ...
      return {
        ...
        trailing: [
          '',
          chalk.hex(colors.muted)('Add guidance for Bari, or leave this blank.'),
          ...this.denyInput
            .render(Math.max(1, contentWidth))
...
function permissionDecisionDetail(decision: TuiPermissionDecision): string {
  ...
  return 'Bari asks again in a new conversation';
}
  ...
  const candidates =
    decision === 'allowOnce'
      ...
      : decision === 'allowAlways'
        ...
        : [`${prefix} Deny and guide Bari`, `${prefix} Deny and guide`, `${prefix} Deny`];
  return (
