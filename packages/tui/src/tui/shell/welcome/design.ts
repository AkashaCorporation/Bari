...
export const MINIMAX_CODE_WELCOME_DESIGN = {
  ...
  tipPool: [
    ...
    'Run /init to teach Bari this repo.',
    ...
    'Use /permission to choose how Bari handles tool approvals.',
  ...
  wide: {
    ...
    news: [
      'Send follow-ups while Bari works.',
  ...
  stacked: {
    ...
    news: ['Follow-ups wait while Bari works.', '/context budget · /feedback preview'],
  },
  compact: {
    tips: [
