/**
 * `@bari/agent-runtime` — pluggable extension SPI + per-turn assembler on top of
 * `@bari/agent-core`.
 *
 ...
 * NOT the flat `@bari/agent-core/protocol` wire shape.
 */
 ...
 * `@bari/agent-core` (see document §11.6 migration strategy).
 */
