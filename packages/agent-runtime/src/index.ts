/**
 * `@bari/agent-runtime` — pluggable extension SPI + assembleTurn assembler.
 *
...
export { defineRuntimeTool } from '@bari/agent-core/tools';
export type { ToolExecutionContext } from '@bari/agent-core/tools';
export {
