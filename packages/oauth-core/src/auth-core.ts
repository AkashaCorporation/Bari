...
export class AuthRequiredError extends Error {
  ...
  constructor(options?: ErrorOptions) {
    super('Bari authentication is required.', options);
...
export class AuthLoginCancelledError extends Error {
  ...
  constructor() {
    super('Bari OAuth device authorization was cancelled.');
...
export class AuthScopeUpgradeRequiredError extends Error {
  ...
  constructor(readonly missingScopes: string[]) {
    super('The current Bari authorization does not include the required scope.');
...
export class AuthResourceContractMismatchError extends Error {
  ...
  constructor() {
    super('The stored credential does not match the Bari resource contract.');
...
export class AuthDomainConflictError extends Error {
  ...
  constructor(
    ...
    super(
      `Bari is signed in to ${active.buildEnv}/${active.region}; sign out before using ${requested.buildEnv}/${requested.region}.`,
    );
