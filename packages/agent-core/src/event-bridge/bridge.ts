...
import { LLM_ERROR_CODES, classifyLLMErrorToCode } from '@bari/shared/llm-error-classifier';
import {
 ...
 *
 * Keep a local copy to avoid making `@bari/agent-core` depend on the UI package. Keep both sets
