/**
 * `systemReminderExtension`: Installs `SystemReminderService` through the `@bari/agent-runtime`
...
import type { AgentExtension, ExtensionAPI, TurnAssemblyCtx } from '@bari/agent-runtime';
import type {
  MessageRequest,
  SessionInfo,
