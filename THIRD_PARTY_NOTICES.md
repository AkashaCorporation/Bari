...
- **MiMo Code**: the bundled `compose-next`, `dream`, and `distill` skills are adapted from [MiMo Code](https://github.com/XiaomiMiMo/MiMo-Code), MIT, Copyright (c) 2026 MiMo Code, Xiaomi Corporation (itself a fork of opencode, Copyright (c) 2025 opencode). The text is adapted to this distribution's tool names and conventions.
